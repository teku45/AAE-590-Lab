...
v_r = .15;                      %right wheel velocity command [m/s]
v_l = .15;                      %right wheel velocity command [m/s]
...
%% loading data
measurements = readtable("run_1.csv",'VariableNamingRule','preserve');     %importing csv data
